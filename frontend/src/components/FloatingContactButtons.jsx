  ...
  return (
    <div className="fixed right-3 sm:right-4 top-1/2 -translate-y-1/2 z-50 flex flex-col gap-3 items-center">
      <a 
        ...
        title="Call Us"
      >
        <FiPhone className="text-base sm:text-lg group-hover:scale-110 transition" />
      </a>
      <a 
        ...
        title="WhatsApp"
      >
        <FaWhatsapp className="text-lg sm:text-xl group-hover:scale-110 transition" />
      </a>
      <a 
        ...
        title="Location"
      >
        <FiMapPin className="text-base sm:text-lg group-hover:scale-110 transition" />
      </a>
    </div>
  );
};
